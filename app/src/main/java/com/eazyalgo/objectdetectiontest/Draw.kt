...
class Draw(context: Context?, var rect: Rect, var objectName: String ) : View(context) {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.drawText(objectName, rect.centerX().toFloat(), rect.centerY().toFloat(),textPaint)
